...
Class my_applications extends CModule {

    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "my.applications";
    var $MODULE_ID = "my.applications";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("my.uni_MODULE_NAME");
        $this->MODULE_DESCRIPTION = GetMessage("my.uni_MODULE_DESC");
